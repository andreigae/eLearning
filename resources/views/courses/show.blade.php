    ...
    <div class="row movileview">
        <div class="d-none d-md-block col-12" style="padding-left: 4px;">
            <ol class="breadcrumb pb-1 mb-1">
                ...
                <li class="breadcrumb-item"><a href="student-browse-courses.html">{{ $course->name }}</a></li>
                <li class="breadcrumb-item"><a href="student-browse-courses.html">{{ $module->name }}</a></li>
                            ...
                            @else --}}
                                <li class="list-group-item">
                                    <div class="row">
                                           ...
                                           <div class="media-left justify-content-center align-self-center">
                                            <div class="text-dark"> {{$lesson->name}}</div>
                                        </div>
                                        <div class="media-body justify-content-center align-self-center">
                                             <a class="text-dark" href="{{-- {{ URL::route('ShowClass', array('Modulo' => $valor['Modulo'], "class"=>$valor['class'])) }} --}}">{{$lesson->name}}</a>
                                        </div>
                                        <div class="media-right justify-content-center align-self-center">
                                            {{-- @if($valor['Estado']==0)
